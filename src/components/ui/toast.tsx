...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Viewport
    ref={ref}
    className={cn(
      "fixed top-20 left-0 right-0 z-[100] flex max-h-screen w-full flex-col p-4 sm:bottom-0 sm:right-0 sm:left-auto sm:top-auto sm:flex-col md:max-w-[420px]",
      className,
    )}
    style={{
      paddingTop: 'calc(3.5rem + env(safe-area-inset-top) + 1rem)',
      paddingBottom: '0', // No bottom padding on mobile to avoid nav overlap
    }}
    {...props}
  />
));
